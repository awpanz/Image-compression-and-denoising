...
def mode3():
    ...
    print("Number of non zeroes in uncompressed image: "+str(nonzerozero))
    print("Number of non zeroes in 20% compressed image: "+str(nonzeroone))
    print("Number of non zeroes in 40% compressed image: "+str(nonzerotwo))
    print("Number of non zeroes in 60% compressed image: "+str(nonzerothree))
    print("Number of non zeroes in 80% compressed image: "+str(nonzerofour))
    print("Number of non zeroes in 99.9% compressed image: "+str(nonzerofive))
    ...
    ax2.title.set_text('20% compression'+str(nonzeroone))
    ax3.title.set_text('40% compression'+str(nonzerotwo))
    ax4.title.set_text('60% compression'+str(nonzerothree))
    ax5.title.set_text('80% compression'+str(nonzerofour))
    ax6.title.set_text('99.9% compression'+str(nonzerofive))
    plt.show()
...
def mode4():
    ...
    plt.title(
        "Execution time of fft and dft in 2-dimensions depending on the size of the square matrix")
    plt.legend()
    for i in range(len(dftsizes)):
